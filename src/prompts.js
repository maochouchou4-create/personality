...
export const DEFAULT_TEMPLATES = {
    ...
    // 取自模板调研的社区共识（说话风格/小动作 5/5 份模板出现、情绪反应 4/5、
    // 矛盾点与负向清单 3/5）——用户是抢话党，AI 演得像不像靠这些叶撑。
    user:
`基本信息:
  姓名: {{user}}
  年龄:
...
3. 值要精炼——每个叶子值是一句短语或短句（≤20 个汉字），除非该块明确是叙事性的（如背景故事）；性格块的可扮演叶（情绪反应/小动作习惯/说话风格/口头禅）须写清触发情境与具体表现，长度可适当放宽。不灌水、不凑字、不复述字段名。
